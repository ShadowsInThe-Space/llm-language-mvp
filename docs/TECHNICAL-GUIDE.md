# Technischer Einstieg — Installation, Compiler und Prüfungen
...
Vertrag und Migration: [docs/W2-SPEC.md](W2-SPEC.md).
...
Anleitung, Architektur und Betrieb: [docs/W1-GUIDE.md](W1-GUIDE.md).
Vor der Implementierung eingefrorene Sprache: [docs/W1-SPEC.md](W1-SPEC.md).
Expertenplan: [docs/W1-PLAN.md](W1-PLAN.md).
Browser- und Compilerabnahme: [docs/W1-ABNAHME.md](W1-ABNAHME.md).
...
Details: [docs/ABNAHME.md](ABNAHME.md).
...
Grammatik und Regelübersicht: [docs/P0.md](P0.md).
Beispielaufgaben: [docs/GOLDEN-PROGRAMS.md](GOLDEN-PROGRAMS.md).
Architektur und Vertrauensgrenzen: [docs/ASSURANCE.md](ASSURANCE.md).
